    ...
    <header className="border-b-4 border-nb-border bg-nb-surface">
      <div className="flex items-center justify-between px-6 py-3">
        <div className="flex items-center">
          <button
            className="md:hidden border-2 border-nb-border w-9 h-9 flex items-center justify-center mr-3 hover:bg-nb-lime hover:text-black transition-colors cursor-pointer text-nb-text"
            onClick={onMenuOpen}
