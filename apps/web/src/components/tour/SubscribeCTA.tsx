      ...
      <div className="flex flex-col gap-4">
        ...
        <ul className="flex flex-col gap-2">
          {features.map((feature) => (
            <li key={feature} className="flex items-center gap-3">
              <span className="flex-shrink-0 size-5 border-2 border-nb-lime bg-nb-lime/20 flex items-center justify-center">
        ...
        <div className="flex gap-3 mt-6">
          ...
          <button
            ...
            className="flex-1 px-4 py-2 border-3 border-nb-border bg-nb-lime text-black font-display text-sm font-bold uppercase shadow-nb hover:translate-x-[2px] hover:translate-y-[2px] hover:shadow-none cursor-pointer transition-all"
          >
            View Plans
          </button>
        </div>
